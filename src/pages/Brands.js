						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-1.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-2.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-4.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-5.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-6.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-7.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-8.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-9.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-10.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-11.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-12.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-13.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-14.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-15.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-16.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-17.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
						...
						<div class='col-xl-2 col-lg-3 col-md-4 col-6'>
							<figure class='card border-1'>
								<div class='card-header bg-white text-center'>
									<img
										height='76'
										src='assets/imgs/brands/brand-18.jpg'
										class='img-fluid'
										alt='Logo'
									/>
								</div>
