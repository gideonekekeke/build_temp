				...
				<div class='card-body'>
					<div class='row'>
										...
										<tr>
											...
											<td>
												<div class='icontext'>
													<img
														class='icon border'
														src='assets/imgs/card-brands/1.png'
														alt='Payment'
													/>
										...
										<tr>
											...
											<td>
												<div class='icontext'>
													<img
														class='icon border'
														src='assets/imgs/card-brands/3.png'
														alt='Payment'
													/>
										...
										<tr>
											...
											<td>
												<div class='icontext'>
													<img
														class='icon border'
														src='assets/imgs/card-brands/4.png'
														alt='Payment'
													/>
						...
						<aside class='col-lg-3'>
							<div class='box bg-light' style = {{minHeight: "80%"}}>
								...
								<p>
									<a href='#'>
										Adidas Air Jordan{" "}
										<i class='icons material-icons md-launch'></i>
									</a>
									<br />
									<a href='#'>
										{" "}
										Great product <i class='icons material-icons md-launch'></i>{" "}
									</a>
								</p>
								<br />
								<p>Payment: PayPal</p>
